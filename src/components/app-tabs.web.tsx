...
/** Web counterpart to the native tab bar. Same five views, same order. */
    ...
    <Tabs>
      ...
      <TabList asChild>
        <CustomTabList>
          ...
          <TabTrigger name="backlog" href="/backlog" asChild>
            <TabButton>Backlog</TabButton>
          </TabTrigger>
          <TabTrigger name="everything" href="/everything" asChild>
            <TabButton>Everything</TabButton>
          </TabTrigger>
        </CustomTabList>
      </TabList>
    </Tabs>
